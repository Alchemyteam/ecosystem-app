        ...
        <div className="flex-1 bg-white h-full overflow-hidden flex flex-col">
          <div className="flex-1 overflow-y-auto min-h-0">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-4">
              ...
              {notification && (
                <div
                  className={`mb-6 rounded-2xl border px-4 py-3 text-sm flex items-center gap-2 ${notification.type === 'success'
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 mt-12">
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-base font-semibold text-slate-900">Search Products</h3>
                ...
                <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-xl p-6 border border-pink-200">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-base font-semibold text-slate-900">Wishlist</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-0">
                <div className="bg-slate-50 rounded-xl p-6 border border-slate-200">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <h3 className="text-base font-semibold text-slate-900">Total Orders</h3>
                  </div>
                ...
                <div className="bg-slate-50 rounded-xl p-6 border border-slate-200">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <h3 className="text-base font-semibold text-slate-900">Active Orders</h3>
                  </div>
                ...
                <div className="bg-slate-50 rounded-xl p-6 border border-slate-200">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <h3 className="text-base font-semibold text-slate-900">Wishlist Items</h3>
                  </div>
